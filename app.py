...
st.set_page_config(page_title="魔釣 - 明石タイラバ予報 v2.6", page_icon="🎣")
...
def suggest_strategy(h, sun_h, sc, t_diff):
    ...
    if h <= sun_h:
        # 朝マズメ: チャート or オレンジゼブラ
        c1 = "チャート" if h % 2 == 0 else "オレンジゼブラ"
    elif h <= sun_h + 2:
        # 日の出〜9時頃: 光量変化に強い「マジョーラ」を投入！
        # 偶数時間はオレ金、奇数時間はマジョーラゼブラで変化をつける
    ...
    # 本命に対するローテーション
    if c1 == "チャート": c2 = "オレ金"
    elif c1 == "オレンジゼブラ": c2 = "マジョーラゼブラ" # ゼブラ繋がりで変化
    elif c1 == "オレ金": c2 = "赤オレ"
    elif c1 == "マジョーラゼブラ": c2 = "赤オレ" # 変化球 -> 定番
    elif c1 == "コーラ": c2 = "赤オレ"
    elif c1 == "黒/海苔": c2 = "コーラ"
    elif c1 == "赤オレ": c2 = "マジョーラゼブラ" # 定番 -> 変化球
